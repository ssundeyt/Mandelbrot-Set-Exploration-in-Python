...
#starfish region
xmin, xmax, ymin, ymax = -0.71, -0.69, 0.26, 0.28
...
ax.imshow(mandelbrot_result.T, origin='lower', extent=(xmin, xmax, ymin, ymax), cmap='cubehelix')
ax.set_title("Starfish Region")
plt.show()
