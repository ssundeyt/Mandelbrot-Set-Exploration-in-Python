...
xmin, xmax, ymin, ymax = -0.086, -0.085, -0.657, -0.656
width, height = 2000, 2000
max_iter = 500  #user can change

mandelbrot_result = mandelbrot_set(xmin, xmax, ymin, ymax, width, height, max_iter)

fig, ax = plt.subplots(figsize=(20, 20))
ax.imshow(mandelbrot_result.T, origin='lower', extent=(xmin, xmax, ymin, ymax), cmap='twilight_shifted')
ax.set_title("Lightning Bolt")
plt.show()
